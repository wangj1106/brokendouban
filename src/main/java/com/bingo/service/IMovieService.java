...
public interface IMovieService {
    ...
    ServerResponse<PageInfo> getMovieList(int pageNum, int pageSize, String orderBy);
    ServerResponse<PageInfo> getMovieListByCateforty(int pageNum, int pageSize,String orderBy, String movie_keyword);
